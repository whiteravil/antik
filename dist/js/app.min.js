...
document.addEventListener('DOMContentLoaded', function () {
  var fileGroup = document.querySelectorAll('.form-file-label');
  var forms = document.querySelectorAll('form');
  var phones = document.querySelectorAll('.phone-mask');
  var openMobMenuBtn = document.querySelector('.header-menu-btn');
  var closeMobMenuBtn = document.querySelector('.mob-menu-close');
  var mobMenu = document.querySelector('.header-menu');
  var timeSelect = document.querySelectorAll('.callback-fixed-time-item');
  ...
  fileGroup.forEach(function (file) {
    ...
    var visibleTitle = file.querySelector('.form-file-name');
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      e.preventDefault();
      e.stopPropagation();
      var requiredFields = form.querySelectorAll('.is-required');
      var success = form.querySelector('.form-success');
      var canSubmit = true;
      requiredFields.forEach(function (field) {
        var isCheckbox = field.getAttribute('type') === 'checkbox';
  ...
  if (openMobMenuBtn) {
    openMobMenuBtn.addEventListener('click', function (e) {
      e.preventDefault();
  ...
  if (closeMobMenuBtn) {
    closeMobMenuBtn.addEventListener('click', function (e) {
      e.preventDefault();
  ...
  var socCallback = document.querySelector('.soc-callback');

  if (socCallback) {
    var socCallbackOpenBtn = socCallback.querySelector('.soc-callback-button');
    var socCallbackCloseBtn = socCallback.querySelector('.soc-callback-close');
    socCallbackOpenBtn.addEventListener('click', function () {
      socCallback.classList.add('opened');
    });
    socCallbackCloseBtn.addEventListener('click', function () {
      socCallback.classList.remove('opened');
    });
  }

  timeSelect.forEach(function (timeSelectParent) {
    var timeSelectInput = timeSelectParent.querySelector('.callback-fixed-time-item-select');
    var timeSelectInputOptions = timeSelectInput.querySelectorAll('option');
    var timeSelectedElement = timeSelectParent.querySelector('.callback-fixed-time-item-selected');
    var timeSelectedDropdown = timeSelectParent.querySelector('.callback-fixed-time-item-dropdown');
    var timeSelectedDropdownList = timeSelectedDropdown.querySelector('ul');
    timeSelectedElement.innerHTML = timeSelectInput.value;
    timeSelectInput.addEventListener('change', function (e) {
      var val = e.target.value;
      timeSelectedElement.innerHTML = val;
    });
    timeSelectInputOptions.forEach(function (option) {
      ...
      listItem.addEventListener('click', function () {
        var listItems = timeSelectedDropdownList.querySelectorAll('li');
        var value = listItem.getAttribute('data-value');
        listItems.forEach(function (listItemsElement) {
